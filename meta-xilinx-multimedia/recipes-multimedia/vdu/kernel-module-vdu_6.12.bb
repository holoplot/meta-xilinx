...
SRCREV ?= "2da27b30241a40ca4e0d05eb184363cc0669d7b2"
...
SKIP_RECIPE[kernel-module-vdu] = "${@'Only kernel 6.12 and before are supported.' if bb.utils.vercmp_string(d.getVarFlag('XILINX_LINUX_VERSION', d.getVar('XILINX_RELEASE_VERSION')) or 'undefined', "6.13") >= 0 else ''}"
