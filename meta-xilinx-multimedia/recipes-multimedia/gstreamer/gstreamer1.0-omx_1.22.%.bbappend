...
#GSTREAMER_1_0_OMX_CORE_NAME = "${@bb.utils.contains_any('MACHINE_FEATURES', 'vdu vcu2', '${libdir}/libOMX.allegro.core.so.1', '${DEFAULT_GSTREAMER_1_0_OMX_CORE_NAME}', d)}"
#GSTREAMER_1_0_OMX_CORE_NAME = "${@bb.utils.contains_any('MACHINE_FEATURES', 'vcu2', '${libdir}/libOMX.allegro.core.so.1', '${DEFAULT_GSTREAMER_1_0_OMX_CORE_NAME}', d)}"
GSTREAMER_1_0_OMX_CORE_NAME = "${DEFAULT_GSTREAMER_1_0_OMX_CORE_NAME}"
...
#PACKAGE_ARCH = "${@bb.utils.contains_any('MACHINE_FEATURES', 'vdu vcu2', '${MACHINE_ARCH}', '${DEFAULT_PACKAGE_ARCH}', d)}"
#PACKAGE_ARCH = "${@bb.utils.contains_any('MACHINE_FEATURES', 'vcu2', '${MACHINE_ARCH}', '${DEFAULT_PACKAGE_ARCH}', d)}"
