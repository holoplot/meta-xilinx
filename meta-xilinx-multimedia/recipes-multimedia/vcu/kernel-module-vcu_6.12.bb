...
SRCREV = "a3c94571fff6cbbfeedfeb323b576fd35695affb"
...
SKIP_RECIPE[kernel-module-vcu] = "${@'Only kernel 6.12 and before are supported.' if bb.utils.vercmp_string(d.getVarFlag('XILINX_LINUX_VERSION', d.getVar('XILINX_RELEASE_VERSION')) or 'undefined', "6.13") >= 0 else ''}"
