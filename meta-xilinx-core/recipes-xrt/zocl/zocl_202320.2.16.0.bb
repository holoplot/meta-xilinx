...
SKIP_RECIPE[zocl] = "${@'Only kernel 6.1 and before are supported.' if bb.utils.vercmp_string(d.getVarFlag('XILINX_LINUX_VERSION', d.getVar('XILINX_RELEASE_VERSION')) or 'undefined', "6.2") >= 0 else ''}"
