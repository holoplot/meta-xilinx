...
# Exception: IsADirectoryError: [Errno 21] Is a directory: '.../build/tmp/work/cortexa72-cortexa53-basecamp-linux/h5pp/1.0+git/git/quickstart/git-clone-install-with-conanfile.py'
do_source_cleanup() {
